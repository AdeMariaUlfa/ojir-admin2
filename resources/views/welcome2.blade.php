...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('template_home/img/apple-icon.png') }}">
  <link rel="icon" type="image/png" href="{{ asset('template_home/img/favicon.png') }}">
  <title>
        ...
        <ul class="navbar-nav navbar-nav-hover w-110" >
          <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
            <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" id="dropdownMenuPages8" data-bs-toggle="dropdown" aria-expanded="false">
              Pages
              <img src="{{ asset('template_home/img/down-arrow-white.svg') }}" alt="down-arrow" class="arrow ms-1 d-lg-block d-none">
              <img src="{{ asset('template_home/img/down-arrow-dark.svg') }}" alt="down-arrow" class="arrow ms-1 d-lg-none d-block">
            </a>
            <div class="dropdown-menu dropdown-menu-animation dropdown-md p-3 border-radius-lg mt-0 mt-lg-3" aria-labelledby="dropdownMenuPages8">
              <div class="d-none d-lg-block">
                ...
                <a href="{{ asset('template_home') }}../pages/about-us.html" class="dropdown-item border-radius-md">
                  <span class="ps-3">About Us</span>
                </a>
                <a href="{{ asset('template_home') }}../pages/contact-us.html" class="dropdown-item border-radius-md">
                  ...
                  <a class="dropdown-item py-2 ps-3 border-radius-md" href="../presentation.html">
                    <div class="d-flex">
                      ...
                      <div class="w-100 d-flex align-items-center justify-content-between">
                        ...
                        <img src="{{ asset('template_home/img/down-arrow.svg') }}" alt="down-arrow" class="arrow">
                      </div>
                    </div>
                  </a>
    ...
    <div class="container">
      <div class="row mb-7">
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('template_home/img/logos/gray-logos/logo-coinbase.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('template_home/img/logos/gray-logos/logo-nasa.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('template_home/img/logos/gray-logos/logo-netflix.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('template_home/img/logos/gray-logos/logo-pinterest.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('template_home/img/logos/gray-logos/logo-spotify.svg') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('template_home/img/logos/gray-logos/logo-vodafone.svg') }}" alt="logo">
        </div>
      </div>
      <div class="row justify-content-center text-center">
        <div class="col-md-3">
          <h1 class="text-gradient text-info"><span id="state1" countTo="405">0</span>+</h1>
          <h5>Sampah Organik</h5>
          <p>jumlah harian per ton</p>
        </div>
        <div class="col-md-3">
          <h1 class="text-gradient text-info"><span id="state2" countTo="253">0</span>+</h1>
