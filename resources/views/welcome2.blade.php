...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('template_home/img/ojir.png') }}">
  <link rel="icon" type="image/png" href="{{ asset('template_home/img/ojir.png') }}">
  <title>
    Ojir Website
  </title>
  <!--     Fonts and icons     -->
  ...
  <!-- Nucleo Icons -->
  <link href="{{ asset('template_home/css/nucleo-icons.css') }}" rel="stylesheet" />
  <link href="{{ asset('template_home/css/nucleo-svg.css') }}" rel="stylesheet" />
  <!-- Font Awesome Icons -->
  <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
  <link href="{{ asset('template_home/css/nucleo-svg.css') }}" rel="stylesheet" />
  <!-- CSS Files -->
  <link id="pagestyle" href="{{ asset('template_home/css/soft-design-system.css?v=1.0.7') }}" rel="stylesheet" />
</head>
...
<body class="about-us">
  ...
  <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3  navbar-transparent ">
    <div class="container">
      <a class="navbar-brand text-white" rel="tooltip" title="Designed and Coded by Creative Tim" data-placement="bottom" target="_blank">
        <img src="{{ asset('template_home/img/ojir-side-small.png') }}">
      </a>
  ...
  <header class="bg-gradient-dark">
    <div class="page-header min-vh-75" style="background-image: url('{{ asset('template_home/img/waste.jpg') }}');">
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center mx-auto my-auto">
            ...
            <div class="d-flex justify-content-center">
              ...
              <a href="javascript:;"><i class="fab fa-android text-lg text-white me-4"></i></a>
    ...
    <div class="container">
      <div class="row mb-7">
        <!-- <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('template_home/img/dlh_branding_black_dark.png') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('template_home/img/Gerakan Indonesia Bersih.png') }}" alt="logo">
        </div>
        <div class="col-lg-2 col-md-4 col-6 mb-4">
          <img class="w-100 opacity-7" src="{{ asset('template_home/img/LDI Indonesia new logo.png') }}" alt="logo">
        </div> -->
        
      </div>
      <div class="row justify-content-center text-center">
        <div class="col-md-3">
          <h1 class="text-gradient text-info"><span id="state1" countTo="{{ $banksampah }}">0</span>+</h1>
          <h5>Total Bank Sampah</h5>
          <p>jumlah yang terdaftar</p>
        </div>
        <div class="col-md-3">
          <h1 class="text-gradient text-info"><span id="state2" countTo="{{ $member }}">0</span>+</h1>
          <h5>Total Member</h5>
          <p>local hero dan client yang terdaftar</p>
        </div>
        <div class="col-md-3">
  ...
  <section class="pt-sm-7 pb-8 position-relative bg-gradient-dark">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-8 text-start mb-5 mt-5">
          <h3 class="text-white z-index-1 position-relative">Cara Kerja Aplikasi Ojir</h3>
          <p class="text-white opacity-8 mb-0">Berikut merupakan cara kerja aplikasi Ojir. Untuk mengaksesnya dapat diunduh di PlayStore!</p>
        </div>
      </div>
      <div class="row">
              ...
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="{{ asset('template_home/img/registrasi.jpg') }}" alt="image">
                  </div>
                </a>
              </div>
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                <div class="card-body">
                  <h5 class="mb-0">1. Daftar Member</h5>
                  <h6 class="text-info">Client / Local Hero</h6>
                  <p class="mb-0">Ojir menyediakan layanan untuk antar jemput sampah. Registrasi awal bisa memilih sebagai client / local hero.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card card-profile mt-lg-0 mt-5 overflow-hidden">
            <div class="row">
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="{{ asset('template_home/img/trade.jpg') }}" alt="image">
                  </div>
                </a>
              </div>
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                <div class="card-body">
                  <h5 class="mb-0">2. Kegiatan Bertukar Sampah</h5>
                  <h6 class="text-info">Penjemputan sampah oleh local hero</h6>
                  <p>Local Hero sebagai penjemput sampah dan client sebagai penyetor sampah.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card card-profile overflow-hidden z-index-2">
            <div class="row">
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="{{ asset('template_home/img/result.jpg') }}" alt="image">
                  </div>
                </a>
              </div>
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                <div class="card-body">
                  <h5 class="mb-0">3. Hasil Yang Didapatkan</h5>
                  <h6 class="text-info">Bank Sampah, Client, dan Local Hero</h6>
                  <p>Bank Sampah mengolah sampah menjadi produk baru dan client mendapatkan point sebagai feedback.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="card card-profile mt-lg-0 mt-5 overflow-hidden z-index-2">
            <div class="row">
              <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                <a href="javascript:;">
                  <div class="p-3 pe-md-0">
                    <img class="w-100 border-radius-md" src="{{ asset('template_home/img/benefit.jpg') }}" alt="image">
                  </div>
                </a>
              </div>
              <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                <div class="card-body">
                  <h5 class="mb-0">4. Manfaat</h5>
                  <h6 class="text-info">Bagi semuanya</h6>
                  <p>Sampah organik sangat bermanfaat bagi kebersihan lingkungan dan dapat diolah kembali menjadi produk baru. </p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="row justify-content-start">
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>Visi & Misi</h5>
                <p>Pengurangan sampah organik untuk dijadikan produk baru </p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>Manfaat</h5>
                <p>Manfaat dari sampah organik tersebut sangat menguntungkan bagi kedua belah pihak</p>
              </div>
            </div>
          </div>
          <div class="row justify-content-start">
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>Tujuan</h5>
                <p>Menciptakan lingkungan yang bersih dan mengurangi volume sampah organik</p>
              </div>
            </div>
            <div class="col-md-6">
              <div class="info">
                ...
                <h5>Harapan</h5>
                <p>Bisa menyadarkan masyarakat mengenai kebersihan lingkungan</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="card shadow-lg">
            <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1">
              <div class="d-block blur-shadow-image">
                <img src="{{ asset('template_home/img/team.jpeg') }}" alt="img-blur-shadow" class="img-fluid shadow rounded-3">
              </div>
            ...
            <div class="card-body">
              <a href="javascript:;">
                <h5 class="mt-3">
                  Get To Know To Our Developer Team
                </h5>
              </a>
              <p>
                Ojir didirikan dilandaskan ide cemerlang mahasiswa dan dosen dari kampus Politeknik Negeri Malang pada tahun 2021.
              </p>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class=" row">
       <!-- <div class="col-md-12 mb-4 ms-auto">
          <div>
            <h6 class="text-gradient text-primary font-weight-bolder">Ojir Website</h6>
          </div>
          <div>
            ...
            <ul class="d-flex flex-row ms-n3 nav">
              ...
              <li class="nav-item">
                <a class="nav-link pe-1" href="https://www.instagram.com/ojirofficial/" target="_blank">
                  <i class="fab fa-instagram text-lg opacity-8"></i>
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link pe-1" href="" target="_blank">
                  <i class="fab fa-android text-lg opacity-8"></i>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div class="col-12">
          <div class="text-center">
            <p class="my-4 text-sm">
              ...
              </script> Design System by <a href="https://www.instagram.com/ojirofficial/" target="_blank">Ojir Developer</a>.
            </p>
          </div>
        </div>
      </div>
  ...
  <!--   Core JS Files   -->
  <script src="{{ asset('template_home/js/core/popper.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('template_home/js/core/bootstrap.min.js') }}" type="text/javascript"></script>
  <script src="{{ asset('template_home/js/plugins/perfect-scrollbar.min.js') }}"></script>
  <!--  Plugin for TypedJS, full documentation here: https://github.com/inorganik/CountUp.js -->
  <script src="{{ asset('template_home/js/plugins/countup.min.js') }}"></script>
  <!--  Plugin for Parallax, full documentation here: https://github.com/wagerfield/parallax  -->
  <script src="{{ asset('template_home/js/plugins/parallax.min.js') }}"></script>
  <!-- Control Center for Soft UI Kit: parallax effects, scripts for the example pages etc -->
  <!--  Google Maps Plugin    -->
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDTTfWur0PDbZWPr7Pmq8K3jiDp0_xUziI"></script>
  <script src="{{ asset('template_home/js/soft-design-system.min.js?v=1.0.7') }}" type="text/javascript"></script>
  <script>
